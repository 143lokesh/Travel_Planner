...
import { Button, NavbarBrand, NavbarContent,  Dropdown,
    DropdownTrigger,
    Avatar,
    DropdownMenu,
    DropdownItem,
    AvatarIcon,NavbarItem, Navbar as NextNavbar, Link } from '@nextui-org/react'
  ...
  return (
     <NextNavbar isBordered className='min - h - [10vh] bg-vi bg-opacity-10 text-white relative '>
        ...
        <div className='w-full z-10 flex items-center'>
            <NavbarBrand className='cursor-pointer flex items-center'>
            <div
