        ...
        {scrapedFlights.map((flight) => {
          ...
          return (
            ...
            >
              ...
              <div className="bg-violet-100 p-2 rounded-r-xl h-full flex flex-col items-center justify-center gap-5 col-span-3">
                <div>
                  <div>
                    <span className="line-through font-light">
                    ₹ {flight.price *82 + 140 * 82}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-5xl font-bold">₹{flight.price * 82}</span>
